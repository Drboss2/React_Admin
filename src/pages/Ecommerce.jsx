        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$69,9990</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='flex flex-wrap m-3 justify-center gap-1 items-center'>
          {earningData.map((item)=>{
            return(
              <div
                key={item.title}
                className="bg-white dark:text-gray-200 dark:secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl"
              >
                <button type='button'
            ...
            <div className='mt-10 gap-10 flex flex-wrap justify-center'>
              <div className='border-r-1 border-color m-4 pr-10'>
                <div>
                  ...
                  <p>
                    <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white text-xs bg-green-400 ml-3'>20%</span>
                  </p>
                  <p className='text-gray-500 mt-1'>Budget</p>
                </div>
                <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>$89,9009</span>
                  </p>
