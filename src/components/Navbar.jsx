...
const Navbar = () => {
  const {activeMenu,setActiveMenu,isClick,setIsClick,handClick,screenSize,setScreenSize,currentColor}  =  useStateContext()
         ...
         <NavButton 
          ...
          />
           <NavButton 
            title='Notifications'
            dotColor='#03c9D7'
            customFunc={()=>handClick('notification')}
            color={currentColor}
          ...
          >
            <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={()=>handClick('userProfile')}>
               <img className='rounded-full w-8 h-8' src={avatar} alt='avatar'/>
               <p>
                 <span className='text-gray-400 text-14'>Hi,</span>{' '}
                 <span  className='text-gray-400 font0-bold ml-1 text-14'>Voke</span>
               </p>
